                                    ...
                                    @if ($product->productImages)
                                        <div class="row">
                                            @foreach ($product->productImages as $image)
                                                <div class="col-md-2">
                                                    <img src="{{ asset($image->image) }}" class="me-4"
                            ...
                            <div class="tab-pane fade" id="color-tab-pane" role="tabpanel" aria-labelledby="color-tab"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($product->productColor as $productColorItem)
                                                <tr class="product-color-tr">
                                                    <td>
                                                        @if ($productColorItem->color)
                                                            {{ $productColorItem->color->name }}
                                                        @else
                                                            No Color Found
                                                        @endif
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-3" style="width:150px">
                                                            <input type="text"
                                                                value="{{ $productColorItem->quantity }}"
                                                                class="productColorQuantity form-control form-control-sm">
                                                            <button type="button" value="{{ $productColorItem->id }}"
