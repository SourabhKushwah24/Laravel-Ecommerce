                    ...
                    <div class="col-md-12 mb-4">
                        <div class="shadow bg-white p-3">
                            <h4 class="text-primary">
                                Item Total Amount :
                                <span class="float-end"><span>&#8377;</span>{{ $this->totalProductAmount }}</span>
                            </h4>
                            <hr>
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane active show fade" id="cashOnDeliveryTab"
                                                ...
                                                <button wire:loading.attr="disabled" type="button"
                                                    wire:click="cashOnDelivery" class="btn btn-primary">
                                                    <span wire:loading.remove wire:target="cashOnDelivery">
                                                        Place Order (Cash on Delivery)
                                                    </span>
                                                    <span wire:loading wire:target="cashOnDelivery">
                                                        Order Placing
                                                    </span>
                                                </button>
