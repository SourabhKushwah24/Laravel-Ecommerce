<div>
    <div class="footer-area">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h4 class="footer-heading">Laravel E-Commerce</h4>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <p>
                            <i class="fa fa-map-marker"></i> #444, some main road, some area, some street, Rajasthan,
                            india - 328001
                        </p>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> kushwahsourabh81@gmail.com
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2022 - Web IT - Ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-4">
