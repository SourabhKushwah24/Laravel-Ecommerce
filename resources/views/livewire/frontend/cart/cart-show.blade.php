<div class="py-3 py-md-5 ">
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="card shopping-cart">
                    ...
                    @forelse ($cart as $cartItem)
                            ...
                            <div class="cart-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label
                                            class="price"><span>&#8377;</span>{{ $cartItem->product->selling_price }}
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label
                                            class="price"><span>&#8377;</span>{{ $cartItem->product->selling_price * $cartItem->quantity }}
                                        </label>
                                        @php
                        ...
                        @endif
                    @empty
                        <div class="card card-body  text-center p-md-5 mt-2">
        ...
        <div class="row mt-3">
            <div class="col-md-8">
                <h4>
                    Get More Product To Add <a href="{{ url('collections/') }}">Shop Now</a>
                </h4>
            </div>
            <div class="col-md-4">
                <div class="shadow-sm bg-white p-3">
                    <h4>Total:
                        <span class="float-end"><span>&#8377;</span>{{ $totalprice }}</span>
                    </h4>
                    <hr>
